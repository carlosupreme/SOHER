...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified'])->group(function () {
    ...
    Route::resource('/solicitudes', WorkController::class)->except('store', 'destroy', 'update')->names('work');
    ...
    Route::get('/solicitudes/{work}/details', [WorkController::class, 'details'])->middleware('can:work.details')->name('work.details');
