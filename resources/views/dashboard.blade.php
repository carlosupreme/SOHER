...
<x-app-layout>
  <div class="py-6">
    <div class="max-w-7xl px-4 mx-auto sm:px-6 lg:px-8 flex flex-col gap-4 items-center">
      @can('work.create')
      <a href="{{route('work.create')}}" class="w-full text-white group hover:shadow-md shadow-blue-200 dark:shadow-blue-900 rounded-3xl bg-blue-600 hover:bg-blue-800 transition-all py-4 px-6 flex flex-col gap-y-4">
      ...
      <div class="flex flex-col w-full">
        ...
        <div class="w-full shadow-lg rounded-3xl bg-white dark:bg-gray-700 p-4 flex flex-col gap-y-2 shadow-gray-200 dark:shadow-gray-800">
      ...
      @can('work.assigned')
      <a href="{{route('work.assigned-index')}}" class="w-full text-white group hover:shadow-md shadow-orange-200 dark:shadow-orange-900 rounded-3xl bg-orange-600 hover:bg-orange-800 transition-all py-4 px-6 flex flex-col gap-y-4">
        <div class="font-bold flex justify-between py-4">
