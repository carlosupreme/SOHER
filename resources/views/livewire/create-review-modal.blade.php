<div x-data="{ modalOpen: @entangle('open') }" x-show="modalOpen" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title"
            ...
            <div
                ...
                <div class="flex items-center gap-4">
                    <div wire:click="$set('rating', 1)" @class([
                        'group cursor-pointer rounded-lg bg-amber-200 hover:bg-amber-500 dark:bg-gray-900 dark:hover:bg-gray-600 p-2',
                    ...
                    <div wire:click="$set('rating',2)" @class([
                        'cursor-pointer rounded-lg bg-amber-200 hover:bg-amber-500 dark:bg-gray-900 dark:hover:bg-gray-600 p-2',
