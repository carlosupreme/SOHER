...
{{--        MAKE IT GRID IN MEDIUM SCREENS : md:grid md:grid-cols-2 --}}
        <div class="flex flex-col gap-y-4 gap-x-5 ">
            <div class="flex flex-col gap-5 bg-white dark:bg-gray-800 sm:rounded-lg shadow-lg p-4">
                <div class="flex justify-between gap-2">
                    <div class="flex flex-col gap-y-1">
                        ...
                        <div class="flex items-center gap-x-2">
                            ...
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">4.95</p>
                        </div>
                    </div>
                ...
                <div>
                    <p class="text-gray-700 dark:text-gray-400"><i class="fa-regular fa-calendar"></i> &nbsp; Fecha solicitada: <strong>{{$fechaSolicitada}}</strong></p>
                </div>
