    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-col gap-y-4 sm:mt-4">
        ...
        <div class="flex flex-col gap-y-4 gap-x-5 ">
            <div class="flex flex-col gap-5 bg-white dark:bg-gray-800 sm:rounded-lg shadow-lg p-4">
                <div class="flex justify-between gap-12 md:gap-0">
                    <div class="flex flex-col gap-y-1">
                        ...
                        <div class="flex items-center gap-x-2">
                            <a href="{{route('user.show', $work->client) }}" class="font-bold text-blue-500 hover:underline ">{{$work->client->name}}</a>
                ...
                <a href="#work.show-photo" class="flex items-center gap-x-2 relative bg-gray-100 w-fit p-2 rounded-xl" @disabled($work->photo)>
                ...
                <a href="{{route('work.assign', $work)}}" class="inline-flex items-center justify-center px-4 py-2.5 text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
