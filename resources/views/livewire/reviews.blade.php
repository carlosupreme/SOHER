<div id="reviews"
     class="w-full p-4 my-4 flex flex-col gap-y-4 rounded-b-lg rounded-t-lg bg-white dark:bg-gray-800">
      ...
      <article class="flex flex-col gap-y-4">
        <div class="flex flex-col gap-y-2">
          <div class="flex justify-between items-center">
            <a href="{{route('user.show', ['user' => $review->from_user->id])}}" class="hover:underline font-bold text-gray-800 dark:text-gray-300">{{$review->from_user->name}}</a>
        ...
        <h1 class="font-bold text-gray-800 dark:text-gray-200 text-justify">{{$review->title}}</h1>
        <p class="text-gray-800 dark:text-gray-300 text-justify">{{$review->review}}</p>
      </article>
      @unless($loop->last)
        <div class="border-t border-gray-200 dark:border-gray-700"></div>
      @endunless
